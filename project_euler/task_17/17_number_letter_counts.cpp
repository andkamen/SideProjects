...
int main()
{
	...
	else if ((second!="0"&& third=="0"&& fourth!="0")||(second!="0"&& third!="0"&& fourth=="0")||(second!="0"&& third!="0"&& fourth!="0"))
	    name.append(print_digit(second)+" hundred and ");

	if (third=="1") 
	    name.append(print_teen(fourth));

	else if (third!="0"&& third!="0")
	...
	ofstream myfile;
	myfile.open("numbers.txt",std::fstream::app);
	myfile<<name<<endl;
	myfile.close();
